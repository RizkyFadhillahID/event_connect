        ...
        <div class="brand" v-if="!sidebarCollapsed">
          <div class="brand-icon">
            <svg width="28" height="28" viewBox="0 0 40 40" fill="none">
              ...
              <defs><linearGradient id="gAdmin" x1="0" y1="0" x2="40" y2="40"><stop offset="0%" stop-color="#0ea5e9"/><stop offset="100%" stop-color="#0d9488"/></linearGradient></defs>
            </svg>
          </div>
          <div class="brand-details" style="display: flex; flex-direction: column;">
            <span class="brand-name">EventConnect</span>
            <span class="org-name" style="font-size: 10px; color: var(--primary-light); font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Backoffice Portal</span>
          </div>
        </div>
...
.brand-name { font-size: 16px; font-weight: 700; background: linear-gradient(135deg, var(--primary), var(--primary-light)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
.collapse-btn {
